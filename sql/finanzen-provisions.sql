-- Provisions-Tracking (Finanzen) — Copy-Paste für Supabase SQL Editor
-- Erweitert deals + neue rechnungen-Tabelle

-- Deals: Verkaufspreis, Rechnung, Zahlung, MwSt
...
-- provision_status um 'rechnungsgestellt' erweitern
