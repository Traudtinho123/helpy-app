-- E-Signatur / DocuSign — Copy-Paste für Supabase SQL Editor
...
CREATE INDEX IF NOT EXISTS idx_dokumente_company
  ON public.dokumente (company_id);

CREATE INDEX IF NOT EXISTS idx_dokumente_envelope
  ON public.dokumente (signature_envelope_id)
...
GRANT SELECT, INSERT, UPDATE, DELETE
  ON public.dokumente TO authenticated;

-- Storage-Bucket für signierte PDFs (optional — im Dashboard anlegen falls fehlend)
INSERT INTO storage.buckets (id, name, public)
VALUES ('signed-documents', 'signed-documents', false)
ON CONFLICT (id) DO NOTHING;

CREATE POLICY "signed_docs_company_read"
...
CREATE POLICY "signed_docs_service_write"
